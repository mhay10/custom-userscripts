...
// @resource     UI_HTML https://cdn.jsdelivr.net/gh/mhay10/custom-userscripts@main/ezaudiobookdownloader/ezaudiobookdownloader.html
...
(async function () {
    ...
    const trackElements = playlist.querySelectorAll(
        config.pageUi.trackSelector
    );
